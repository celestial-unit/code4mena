...
import { MascotEmotion, MascotInteraction, MascotAnimation } from '../../types/mascot';
...
export const MascotAchievementCelebration: React.FC<MascotAchievementCelebrationProps> = ({
  achievement,
  visible,
  onClose
}) => {
  ...
  useEffect(() => {
    if (visible && achievement) {
      ...
      const celebrationInteraction: MascotInteraction = {
        ...
        culturalElements: achievement.culturalSignificance ? [achievement.culturalSignificance] : []
      };
  ...
  return (
    ...
    >
      <View style={styles.overlay}>
        {/* Confetti Effect */}
        {showConfetti && (
          <Animated.View style={[styles.confettiContainer, animatedConfettiStyle]}>
              ...
              <View
                ...
                style={[
                  styles.confettiPiece,
                  {
                    ...
                    backgroundColor: rarityColors[Math.floor(Math.random() * rarityColors.length)],
        ...
        <Animated.View style={[styles.modalContainer, animatedModalStyle]}>
          ...
          >
            ...
            <Animated.View style={[styles.mascotContainer, animatedMascotStyle]}>
              <TunisianMascot3D size={120} showShadow={false} interactive={false} />
            </Animated.View>
