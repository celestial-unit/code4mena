...
export const MascotCustomization: React.FC<MascotCustomizationProps> = ({
  ...
  const [selectedTab, setSelectedTab] = useState<
    'style' | 'clothing' | 'accessories' | 'colors'
  >('style');
  ...
  const handleCustomizationChange = (
    updates: Partial<MascotCustomizationType>
  ) => {
              ...
              <TouchableOpacity
                ...
                onPress={() =>
                  handleCustomizationChange({
                    culturalVariation: variation.key,
                  })
                }
              >
                <View style={styles.optionHeader}>
                  ...
                  <View style={styles.optionText}>
                    <Text
                      style={[styles.optionName, { color: theme.colors.text }]}
                    >
                      {variation.name}
                    </Text>
                    <Text
              ...
              <TouchableOpacity
                ...
                style={[
                  styles.optionCard,
                  {
                    backgroundColor: theme.colors.surface,
                    borderColor:
                      mascotState.customization.clothingStyle === clothing.key
                        ? theme.colors.primary
                        : theme.colors.border,
                  },
                ]}
                onPress={() =>
                  handleCustomizationChange({ clothingStyle: clothing.key })
                }
              >
                <View style={styles.optionHeader}>
                  <Ionicons
        ...
        return (
          <View style={styles.tabContent}>
            ...
            {accessories.map(accessory => {
              const isSelected = mascotState.customization.accessories.includes(
                accessory.key
              );
              return (
                <TouchableOpacity
                  ...
                  onPress={() => {
                    const currentAccessories =
                      mascotState.customization.accessories;
          ...
          <View style={styles.tabContent}>
            ...
            {colorSchemes.map(scheme => (
              <TouchableOpacity
                ...
                onPress={() =>
                  handleCustomizationChange({ colorScheme: scheme.key })
                }
              >
                <View style={styles.optionHeader}>
                  <LinearGradient
