    ...
    const loadDashboardData = async (isRefresh = false) => {
        try {
            ...
            try {
                ...
                console.warn('API health check failed, using fallback data:', healthError);
            ...
            try {
                ...
                const updates: LegalUpdate[] = popularQueriesResponse.slice(0, 5).map((query: any, index: number) => ({
                    id: `update-${index}`,
                    ...
                    priority: query.popularity > 80 ? 'high' : query.popularity > 50 ? 'medium' : 'low',
                    source: {
                        id: 'api-source',
                    ...
                    impactLevel: query.popularity > 80 ? 'high' : query.popularity > 50 ? 'medium' : 'low',
                    sectors: ['business'],
                    isBookmarked: false
                }));
