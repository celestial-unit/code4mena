  ...
  return (
    ...
    >
      ...
      >
        {/* Background Gradient */}
        <LinearGradient
          colors={achievement.isUnlocked ? (rarityColors as [string, string, string]) : (['#E2E8F0', '#CBD5E0'] as [string, string, ...string[]])}
          style={[
