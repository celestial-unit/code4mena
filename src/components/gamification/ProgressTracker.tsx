          ...
          {nextLevel && (
            <View style={styles.nextLevelInfo}>
              ...
              <Text style={styles.pointsToNext}>
                {(nextLevel.minPoints - currentPoints).toLocaleString()} نقطة
                متبقية
              </Text>
            </View>
          )}
      ...
      {nextLevel && (
        <View style={styles.progressContainer}>
          ...
          <View style={styles.progressLabels}>
            <Text style={styles.progressLabel}>{currentLevel.titleAr}</Text>
            <Text style={styles.progressLabel}>{nextLevel.titleAr}</Text>
          </View>
        </View>
      )}
        ...
        <View style={styles.statCard}>
          ...
          <View style={styles.weeklyProgressBar}>
            ...
            >
              <LinearGradient
                colors={
                  getWeeklyProgressColor() as [string, string, ...string[]]
                }
          ...
          <View style={styles.benefitsList}>
            {currentLevel.benefitsAr.slice(0, 3).map((benefit, index) => (
              <View key={index} style={styles.benefitItem}>
                <LinearGradient
                  colors={
                    currentLevel.gradient as [string, string, ...string[]]
                  }
