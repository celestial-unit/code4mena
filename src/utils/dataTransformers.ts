...
/**
 * Transform JSON mascot to proper TunisianMascot type
 */
export function transformTunisianMascot(jsonMascot: any): TunisianMascot {
  return {
    ...jsonMascot,
    animations: jsonMascot.animations || [],
    customizations: jsonMascot.customizations || [],
    culturalElements: jsonMascot.culturalElements || [],
    tunisianSymbols: jsonMascot.tunisianSymbols || [],
  };
}
...
export function transformTunisianMascots(jsonMascots: any[]): TunisianMascot[] {
  return jsonMascots.map(transformTunisianMascot);
}
